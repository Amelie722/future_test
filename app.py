    ...
    slides = [
        {
            "kicker": "Interest Map",
            "title": "관심이 곧 지도가 됩니다",
            "body": "좋아하는 것을 저장하면 연결된 분야와 전문가가 펼쳐집니다.",
            "page": "3d",
            "cta": "Future Universe 열기",
        },
        {
            "kicker": "Expert Story",
            "title": "직업명보다 실제 이야기를 보세요",
            "body": "전문가의 하루와 작은 미션으로 진로를 먼저 체험합니다.",
            "page": "discovery",
            "cta": "스토리와 미션 보기",
        },
        {
            "kicker": "Q&A",
            "title": "막막하면 바로 물어보세요",
            "body": "학생의 질문이 현장의 답변으로 돌아옵니다.",
            "page": "questions",
            "cta": "전문가 Q&A 보기",
        },
        {
            "kicker": "Next Step",
            "title": "다음 선택을 바로 정리하세요",
            "body": "AI가 관심, 질문, 답변을 모아 실행 가능한 길로 바꿉니다.",
            "page": "career",
            "cta": "AI 진로상담 보기",
        },
    ]
